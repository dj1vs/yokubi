...
Yokubi - это **открытый**, **поддерживаемый сообществом** проект. Мы принимаем любые полезные правки.
...
Если вы хотите внести вклад, вы можете открыть проект [на гитхабе](https://github.com/Morgawr/yokubi), где можно сообщить о проблеме или создать пул-реквест.
